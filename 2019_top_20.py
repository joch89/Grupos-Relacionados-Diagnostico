...
df = pd.read_csv('C:\\Users\\josee\\OneDrive\\Documentos\\Proyectos Propios\\GRD\\Analisis de la Distribucion de los GRD\\Codigos agrupados top 20\\GRD_PUBLICO_2019.txt', sep='|', low_memory=False)
...
tabla_csv_2019 = top_20_combinaciones.to_csv('tabla.csv_2019', index=False)

# Imprime un mensaje para confirmar que el archivo se ha guardado
print("La tabla se ha guardado en 'tabla_2019.csv'")