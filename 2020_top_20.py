...
df = pd.read_csv('C:\\Users\\josee\\OneDrive\\Documentos\\Proyectos Propios\\GRD\\Analisis de la Distribucion de los GRD\\Codigos agrupados top 20\\GRD_PUBLICO_2020.txt', sep='|', low_memory=False)
